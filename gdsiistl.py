...
layerstack = {
    ...
    (64,20): (-0.24, -0.1, 'nwell'),    
    (65,20): (-0.5, 0.1, 'diff'),    
    (66,20): (0.0, 0.2, 'poly'),
    (66,44): (0, 0.94, 'licon'),    
    (67,20): (0.94, 1.04, 'li1'),    
    (67,44): (1.04, 1.38, 'mcon'),    
    (68,20): (1.38, 1.74, 'met1'),    
    (68,44): (1.74, 2.01, 'via'),    
    (69,20): (2.01, 2.37, 'met2'),    
    (69,44): (2.37, 2.79, 'via2'),    
    (70,20): (2.79, 3.64, 'met3'),    
    (70,44): (3.64, 4.03, 'via3'),    
    (71,20): (4.03, 4.88, 'met4'),    
    (71,44): (4.88, 5.38, 'via4'),    
    (72,20): (5.38, 6.65, 'met5'),
}
